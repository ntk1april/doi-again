  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-8 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-md">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100">Add Stock</h1>
          <p className="mt-2 text-gray-600 dark:text-gray-400">Add a new stock to your portfolio</p>
        </div>
