  ...
  if (stocks.length === 0) {
    return (
      <div className="rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 p-8 text-center">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Or if you&apos;re in Custom Tab, click on &quot;✏️ Manage Port&quot;
          to add stocks to your tab.
        </p>
      </div>
    );
  }
        ...
        <div className={tableContainerClass}>
          <table className="w-full text-sm">
            <thead className="border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-700">
              <tr>
                <th
                  className="px-4 py-3 text-left font-semibold text-gray-900 dark:text-gray-100 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors"
                ...
                <th
                  className="px-4 py-3 text-right font-semibold text-gray-900 dark:text-gray-100 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors"
                  onClick={() => handleSort("units")}
                >
                  <div className="flex items-center justify-end gap-1">
                    Shares <SortIcon field="units" />
                  </div>
                </th>
                <th
                  className="px-4 py-3 text-right font-semibold text-gray-900 dark:text-gray-100 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-600 transition-colors"
